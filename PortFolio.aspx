<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PortFolio.aspx.cs" Inherits="Projects" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="margin_bottom_10"></div>
     ...
     <img src="images\lui.jpg" alt="50" style="width:856px;height:482px">
