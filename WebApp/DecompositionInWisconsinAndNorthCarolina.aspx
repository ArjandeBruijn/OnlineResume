...
<!--            <canvas style= "border:1px solid black">Your browser does not support the HTML5 canvas tag.</canvas>-->
         ...
         <p> Bayesian calibration is a method to map model probability, given a set of observations. It has been used in disciplines as diverse as medicine, law and internet search engines. 
               I used it to estimate the rate of wood decomposition. You can use an algorithm called a Markov Chain to generate semi-random decomposition rates, 
               calculate remaining biomass in time and calculate a score that represents how likely the random decomposition rate is. 
               ...
               It takes a while for the Markov Chain to find this 'hotspot' of high model scores, but after ~100 iterations, the most frequent decomposition rate generated through the 
               iterations stabilizes around 7%.
               So the best estimate of the decomposition rate of the wood measured here is 7% per year.

               <br><br>
               Additional to a parameter optimization, the frequency of parameter values that were generated by the Monte Carlo algorithm can be plotted into probability densities 
               which gives you an idea of parameter sensitivity.
      ...
      <br>
      <i>Graphics: Parameter estimation with Markov Chain Monte Carlo (static on mobile browsers)   </i>
