    ...
    <div  style="width:940px;    float:left; padding:10px; background-color : White">
        <h2>The PnET-Succession model and its interface</h2>
         ...
         <div  style="float:left; padding:10px; background-color : White">
          ...
          <p>
          The  <a href="http://www.landis-ii.org/extensions/pnet-succession">PnET-Succession</a>   model interacts with the more comprehensive <a href="http://www.landis-ii.org/">LANDIS-II</a>
           simulation platform that predicts forest dynamics in terms of species configuration and biomass. The name PnET-Succession is derived from the  <a href="http://www.pnet.sr.unh.edu/">PnET</a> 
            
            model that predicts foliage cover and biomass and the <a href="http://www.landis-ii.org/extensions/biomass-succession">LANDIS-II biomass succession</a> 
            
           extension for landis that predicts forest how trees compete and what species, under which circumstances, is most likely to dominate the future of a 
           forest. <br><br> When I started using LANDIS-II for my research at Purdue University, I was unsatisfied with the common practice to use predictions of tree growth and biomass by the
            PnET model as input for LANDIS-II without taking into account the information that was generated by the LANDIS-II model.
           
           As an alternative, I incorporated the PnET model into LANDIS-II. The resulting PnET-Succession model 
           ...
           I developed a simple user interface.
           
           The interface (image) is a windows forms application with a file tree (on the left) and a working space (on the right) that allows you to view various types of output files. 
           
           When you add a scenario, the program will add all associated input files to the file tree.
            
          The user interface will add additional simulation output files to the file tree when the user starts a simulation.
          ...
          The user interface makes use of a variety of freeware:
            <ul>
