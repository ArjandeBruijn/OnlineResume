...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <h1>About me</h1>
     <p class = "justify">
        I have enjoyed being employed in academics in three different coutries. I have a considerable publication record, taught at presentations and workshops, I have a PhD, Msc and M.A.
        However, for various reasons I am currently more interested in a job in the private sector. The main skills that I have to offer are in the area of computer programming, 
        with more than eight years of experience in a variety of coding languages and disciplines. I worked a lot with geospatial software in particular, I coded a plugin in ArcMap and 
        used the geospatial freeware MapWinGIS as an embedded feature in some windows software. I would love to make use if this in my new job. 
        
        I developed this website to demonstrate some of my software development skills and 
        work so employers may have a better impression about my capacities and how these could benefit their product. 
        
        <!--
         I prefer the more technical elements of my PhD and post-doctoral work (i.e. the programming) over the drier mathematical 
        work and I feel that I am better suited to the pace of the private sector. So In particular, it serves to demonstrate that 
...
<!--
     ...
     <div id="column_55">
        ...
        <p>
            Markov Chain Monte Carlo is a method to estimate values of typical model parameters by iterative random samples of those parameters. Red lines above are simulated 
            defoliation areas in Northern Minnesota compared to (black lines + markers) defoliation derived from arial photographs.
    ...
    <div id="column_45">
        ...
        <p>
            Simulation of Gypsy Moth outbreaks in Green Ridge State Forest (GRSF). GRSF was a test case study area that I used to predict forest dynamics, for example growth, new invading tree species and 
            local extinctions. 
            
            <!--
             the potential fate of reintroduced blight-resistant 
            ...
            different tree species and how they interact with disturbances such as mentioned pests, harvests and controlled burning. 
