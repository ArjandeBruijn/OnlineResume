...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2><center>Software skills</center></h2>
     <div style="width:45%;float:left; padding : 10px">
         <img src="images\ProgramIcons\matrix.png"   align="left">
   ...
   <div style="width:45%;float:left; padding : 10px">
         <img src="images\ProgramIcons\R.jpg"   align="left">
    ...
    <div style="width:45%;float:left; padding : 10px">
         ...
         I worked for 1 year on a simulation model that was designed as a plugin for ArcGIS. For the past 3 years at Purdue University, I have used ArcGIS to modify input and output maps for the simulation model 
        <a href="http://www.landis-ii.org/">LANDIS</a>
    </div>
    <div style="width:45%;float:left; padding : 10px">
    ...
    <div style="width:45%;float:left; padding : 10px">
          <img src="images\ProgramIcons\Microsoft Office.png"   align="left">
